 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/helloWord?wsdl")
public class HelloWebServiceService extends Service {
    ...
    private final static QName HELLOWEBSERVICESERVICE_QNAME = new QName("http://ws/", "HelloWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/helloWord?wsdl");
    ...
    public HelloWebService getHelloWebServicePort() {
        return super.getPort(new QName("http://ws/", "HelloWebServicePort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "HelloWebServicePort"), HelloWebService.class, features);
    }
